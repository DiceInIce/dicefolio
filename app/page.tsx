  ...
  return (
    <main className="flex items-center h-screen relative bg-cover bg-[url('/assets/bg-explosion.png')]">
      ...
      <div className="flex flex-col gap-3 z-[10] pl-10 md:pl-40 pt-20">
        <h1 className="text-[50px] text-white max-w-[600px]">Transforming ideas into {" "}
        ...
        <p className="text-[16px] text-gray-200 md:text-gray-400 mb-10 md:pb-2 max-w-[400px]">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia modi praesentium quaerat enim, illum deleniti expedita est dolores odio pariatur.
        </p>
